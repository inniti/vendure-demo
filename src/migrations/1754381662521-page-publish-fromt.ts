...
export class PagePublishFromt1754381662521 implements MigrationInterface {

   public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "temporary_page" ("createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "publishFrom" datetime)`, undefined);
        await queryRunner.query(`INSERT INTO "temporary_page"("createdAt", "updatedAt", "id") SELECT "createdAt", "updatedAt", "id" FROM "page"`, undefined);
        await queryRunner.query(`DROP TABLE "page"`, undefined);
        await queryRunner.query(`ALTER TABLE "temporary_page" RENAME TO "page"`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP TABLE "temporary_order_modification"`, undefined);
        await queryRunner.query(`CREATE INDEX "IDX_1df5bc14a47ef24d2e681f4559" ON "order_modification" ("orderId") `, undefined);
        await queryRunner.query(`ALTER TABLE "page" RENAME TO "temporary_page"`, undefined);
        ...
        await queryRunner.query(`INSERT INTO "page"("createdAt", "updatedAt", "id") SELECT "createdAt", "updatedAt", "id" FROM "temporary_page"`, undefined);
        await queryRunner.query(`DROP TABLE "temporary_page"`, undefined);
   }
